...
export SEL4CP_DIR="$HOME/cp/sel4cp"
rm -r $HOME/cp/sel4cp/tmp_build
$HOME/cp/pyenv/bin/python3.9 dev_build.py --board=maaxboard --example=xhci_stub
sudo cp $HOME/cp/sel4cp/tmp_build/loader.img /var/lib/tftpboot/loader-josh.img
echo 
echo Copied image file to "/var/lib/tftpboot/loader-josh.img".
